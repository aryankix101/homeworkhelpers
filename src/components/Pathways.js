                        ...
                        <body>
                            <style>{'body { background-color: #A8D0E6; }'}</style>
                                <div class="container">
                                    ...
                                    <p><li>Fun and exciting virtual experience</li><li>Learn skills in STEAM subjects (Science, Technology, English, Art, and Math) Our <a href="/curriculums">curriculums</a>.</li><li>Bi-weekly enrichment packets to boost your skills</li><li>Learn at a personalized and individual pace from experienced mentors</li><li>Receive badges and awards for your achievements</li><li>Students can choose to learn any subjects(s) they want</li><li>Available to ALL ages and levels!</li></p>
                                    <p><br/>Sign up now <a href="https://tinyurl.com/steam-pathways" target="_blank">here</a>. We hope you will join us to explore the world of learning with STEAM Pathways!</p>
